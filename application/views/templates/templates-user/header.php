...
<head>
  ...
  <link href="<?= base_url(); ?>/assets/img/logo/logo.jpg" rel="icon" type="image/png">
  ...
  <script type="text/javascript" scr="<?= base_url('assets/'); ?><datatable/jquery.dataTables.js'; ?>"></script>
  <script type="text/javascript" scr="<?= base_url('assets/'); ?><datatable/jquery.datatables.js'; ?>"></script>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            ...
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" arial-abel="Toggle navigation">
