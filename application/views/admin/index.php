...
<!-- Row ux -->
          ...
          <!-- row table -->
          <div class="row">
                <div class="table-responsive table-bordered col-sm-5 ml-3 mr-3 mt-2 ">
                ...
                <div class="table-responsive table-border col-sm-5 ml-3 mr-3 mt-2">
                    <div class="page-header">
                    ...
                    <table class="table mt-3" id="table-datable">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Judul Buku</th>
